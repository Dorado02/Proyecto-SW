...
public class PantallaMenu extends JPanel {
	...
	public PantallaMenu(Ventana v) {
		...
		botonOp4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (ventana.usuarioLogeado.getEntrenamiento() == null || ventana.usuarioLogeado.getNivel() == 0) {
					JOptionPane.showMessageDialog(ventana, "Selecciona tu nivel y tu entrenamiento", "Error",
		...
		BotonMenu botonCerrar = new BotonMenu("Cerrar");
		...
		gl_panelIzquierda.setHorizontalGroup(gl_panelIzquierda.createParallelGroup(Alignment.LEADING)
				.addComponent(botonPerfil, GroupLayout.PREFERRED_SIZE, 106, GroupLayout.PREFERRED_SIZE)
				.addComponent(botonEditar, GroupLayout.PREFERRED_SIZE, 106, GroupLayout.PREFERRED_SIZE)
				.addComponent(botonCerrar, GroupLayout.DEFAULT_SIZE, 106, Short.MAX_VALUE));
		gl_panelIzquierda.setVerticalGroup(gl_panelIzquierda.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelIzquierda.createSequentialGroup()
						.addComponent(botonPerfil, GroupLayout.PREFERRED_SIZE, 43, GroupLayout.PREFERRED_SIZE)
